...
ls(char *path)
{
 ...
 113:	0f 88 d7 01 00 00    	js     2f0 <ls+0x200>
 ...
 12d:	0f 88 05 02 00 00    	js     338 <ls+0x248>
 ...
 1b8:	0f 87 5a 01 00 00    	ja     318 <ls+0x228>
 ...
 1ec:	8d 48 01             	lea    0x1(%eax),%ecx
            ...
            strcpy(buf, path);
            p = buf+strlen(buf);
 1ef:	89 85 b4 fd ff ff    	mov    %eax,-0x24c(%ebp)
            *p++ = '/';
 1f5:	89 8d b0 fd ff ff    	mov    %ecx,-0x250(%ebp)
 ...
 265:	8d 85 e8 fd ff ff    	lea    -0x218(%ebp),%eax
            *p++ = '/';
            while(read(fd, &de, sizeof(de)) == sizeof(de)){
                if(de.inum == 0) continue;
                memmove(p, de.name, DIRSIZ);
                p[DIRSIZ] = 0;
                if(stat(buf, &st) < 0){
 26b:	0f 88 ef 00 00 00    	js     360 <ls+0x270>
                    printf(1, "ls: cannot stat %s\n", buf);
                    continue;
                }
                if (fmtname(buf)[0] != '.' )
 271:	89 04 24             	mov    %eax,(%esp)
 274:	e8 d7 fd ff ff       	call   50 <fmtname>
 279:	80 38 2e             	cmpb   $0x2e,(%eax)
 27c:	74 82                	je     200 <ls+0x110>
                    printf(1, "%s %d %d %d\n", fmtname(buf), st.type, st.ino, st.size);
 27e:	0f bf 95 d4 fd ff ff 	movswl -0x22c(%ebp),%edx
 285:	8b 8d e4 fd ff ff    	mov    -0x21c(%ebp),%ecx
 28b:	8b 85 dc fd ff ff    	mov    -0x224(%ebp),%eax
 291:	89 95 a8 fd ff ff    	mov    %edx,-0x258(%ebp)
 297:	8d 95 e8 fd ff ff    	lea    -0x218(%ebp),%edx
 29d:	89 14 24             	mov    %edx,(%esp)
 2a0:	89 8d a4 fd ff ff    	mov    %ecx,-0x25c(%ebp)
 2a6:	89 85 ac fd ff ff    	mov    %eax,-0x254(%ebp)
 2ac:	e8 9f fd ff ff       	call   50 <fmtname>
 2b1:	8b 8d a4 fd ff ff    	mov    -0x25c(%ebp),%ecx
 2b7:	8b 95 a8 fd ff ff    	mov    -0x258(%ebp),%edx
 2bd:	c7 44 24 04 7e 0a 00 	movl   $0xa7e,0x4(%esp)
 2c4:	00 
 2c5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 2cc:	89 4c 24 14          	mov    %ecx,0x14(%esp)
 2d0:	8b 8d ac fd ff ff    	mov    -0x254(%ebp),%ecx
 2d6:	89 54 24 0c          	mov    %edx,0xc(%esp)
 2da:	89 44 24 08          	mov    %eax,0x8(%esp)
 2de:	89 4c 24 10          	mov    %ecx,0x10(%esp)
 2e2:	e8 09 04 00 00       	call   6f0 <printf>
 2e7:	e9 14 ff ff ff       	jmp    200 <ls+0x110>
 ...
 2f4:	c7 44 24 04 56 0a 00 	movl   $0xa56,0x4(%esp)
 2fb:	00 
 2fc:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
 303:	e8 e8 03 00 00       	call   6f0 <printf>
                    printf(1, "%s %d %d %d\n", fmtname(buf), st.type, st.ino, st.size);
            }
            break;
    }
 ...
 314:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        ...
        case T_DIR:
            if(strlen(path) + 1 + DIRSIZ + 1 > sizeof buf){
                printf(1, "ls: path too long\n");
 318:	c7 44 24 04 8b 0a 00 	movl   $0xa8b,0x4(%esp)
 31f:	00 
 320:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 327:	e8 c4 03 00 00       	call   6f0 <printf>
                break;
 32c:	e9 5d fe ff ff       	jmp    18e <ls+0x9e>
 ...
 33c:	c7 44 24 04 6a 0a 00 	movl   $0xa6a,0x4(%esp)
 343:	00 
 344:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
 34b:	e8 a0 03 00 00       	call   6f0 <printf>
        close(fd);
 350:	89 1c 24             	mov    %ebx,(%esp)
 353:	e8 72 02 00 00       	call   5ca <close>
        return;
 358:	e9 39 fe ff ff       	jmp    196 <ls+0xa6>
 ...
 364:	c7 44 24 04 6a 0a 00 	movl   $0xa6a,0x4(%esp)
 36b:	00 
 36c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 373:	e8 78 03 00 00       	call   6f0 <printf>
                    continue;
 378:	e9 83 fe ff ff       	jmp    200 <ls+0x110>
