...
int main (int argc,char **argv){
   ...
   b:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
  12:	00 
  13:	8d 74 24 1f          	lea    0x1f(%esp),%esi
  17:	c7 04 24 56 07 00 00 	movl   $0x756,(%esp)
  1e:	e8 bf 02 00 00       	call   2e2 <open>
  23:	89 c3                	mov    %eax,%ebx
    char temp[1];
    int n;
    while ((n = read(current_pwd,temp,sizeof(temp))) > 0){
  25:	eb 1e                	jmp    45 <main+0x45>
  27:	90                   	nop
            printf(1,"%c",temp[0]);
  28:	0f be 44 24 1f       	movsbl 0x1f(%esp),%eax
  2d:	c7 44 24 04 5b 07 00 	movl   $0x75b,0x4(%esp)
  34:	00 
...
int main (int argc,char **argv){
    ...
    int n;
    while ((n = read(current_pwd,temp,sizeof(temp))) > 0){
  45:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  4c:	00 
  4d:	89 74 24 04          	mov    %esi,0x4(%esp)
  51:	89 1c 24             	mov    %ebx,(%esp)
  54:	e8 61 02 00 00       	call   2ba <read>
  59:	85 c0                	test   %eax,%eax
  5b:	7f cb                	jg     28 <main+0x28>
            printf(1,"%c",temp[0]);
    }
    printf(1,"\n");
  5d:	c7 44 24 04 5e 07 00 	movl   $0x75e,0x4(%esp)
  64:	00 
  65:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  6c:	e8 7f 03 00 00       	call   3f0 <printf>
    close(current_pwd);
  71:	89 1c 24             	mov    %ebx,(%esp)
  74:	e8 51 02 00 00       	call   2ca <close>

    exit();
  79:	e8 24 02 00 00       	call   2a2 <exit>
  7e:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 389:	0f b6 92 67 07 00 00 	movzbl 0x767(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 51f:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 521:	b8 60 07 00 00       	mov    $0x760,%eax
